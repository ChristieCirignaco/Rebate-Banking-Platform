/**
 * countries.ts — self-contained ISO 3166-1 country data.
 *
 * A pure data module (no imports, no runtime side effects) providing the full
 * list of world countries/territories for a registration form's Country
 * dropdown and international phone dial-code selector.
 *
 * Each entry carries the common English name, ISO 3166-1 alpha-2 code, the
 * E.164 calling code (with leading "+"), and the regional-indicator emoji flag.
 * Note: NANP members (US, CA, and Caribbean territories) all share "+1" — this
 * is correct; duplicate dialCode values are expected. COUNTRIES is sorted
 * alphabetically by name.
 */

export type Country = {
  /** Common English name, e.g. "Nigeria", "United States", "United Kingdom". */
  name: string;
  /** ISO 3166-1 alpha-2 code, UPPERCASE, e.g. "NG", "US", "GB". */
  code: string;
  /** E.164 calling code with leading "+", e.g. "+234", "+1", "+44". */
  dialCode: string;
...
export const COUNTRIES: Country[] = [
  ...
  { name: "Bonaire, Sint Eustatius and Saba", code: "BQ", dialCode: "+599", flag: "🇧🇶" },
  ...
  { name: "Heard Island and McDonald Islands", code: "HM", dialCode: "+672", flag: "🇭🇲" },
...
/** Lookup map keyed by ISO 3166-1 alpha-2 code (uppercase). */
...
/**
 * Resolve a country by its ISO 3166-1 alpha-2 code (case-insensitive).
 * Returns undefined when no country matches.
 */
...
/** Default country for the registration form (Nigeria). */
