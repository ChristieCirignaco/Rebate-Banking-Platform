...
import { WithdrawReviewDialog } from "./withdraw-review-dialog";
import type { WithdrawRequest } from "./types";

export function WithdrawRequestsTab({ requests }: { requests: WithdrawRequest[] }) {
            ...
            {filtered.length === 0 ? (
              <TableRow>
                <TableCell colSpan={5} className="text-muted-foreground h-24 text-center">
                  No pending manual withdrawal requests.
                </TableCell>
              </TableRow>
            ) : (
                ...
                <TableRow key={request.id}>
                  ...
                  <TableCell>
                    <div className="flex flex-col">
                      <span className="text-sm">
                        {request.description ?? "Manual withdrawal"}
                      </span>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end">
                      <WithdrawReviewDialog request={request} />
                    </div>
                  </TableCell>
                </TableRow>
              ))
