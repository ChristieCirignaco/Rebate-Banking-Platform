...
export function AdminProfileForm({ initial }: { initial: AdminProfileInitial }) {
  ...
  // Upload immediately (so the photo shows right away) but only stage the URL — "Save changes"
  // is what writes User.image, keeping every field behind one action/gate.
    ...
    <Card>
      <CardContent className="pt-6">
        <form onSubmit={onSubmit} noValidate className="flex flex-col gap-5">
          ...
          {/* Email is read-only here (identity), with a verification indicator. */}
          <div className="flex flex-col gap-1.5">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              ...
              <Select value={gender} onValueChange={(v) => setGender(v as Gender)} disabled={saving}>
